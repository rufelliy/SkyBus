...
<div class="rout">
    <div class="abt_rout">
        <div class="route">
            <div class="title">
                <h3>Маршрут<br>№2</h3>
                <h5>м. Бориспіль(вул.Каховська)<br>
                    ДП МА "Бориспіль"</h5>
            </div>
...
<script>
    function initMap() {
        var markerArray = [];
        var start = {lat: 50.334634, lng: 30.986049};
        var finish = {lat: 50.341473, lng: 30.894373};
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="timetable">
                        <table class="table">
                            <tr>
                                <td class="table_header">вулиця Каховська</td>
                                <td class="table_header">Центр (міський парк)</td>
...
<!--                <h3>Місце посадки (м.Бориспіль(вул.Каховська))</h3>-->
