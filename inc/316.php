...
<div class="rout">
	<div class="abt_rout">
		<div class="route">
			<div class="title">
				<h3>Маршрут<br>№316</h3>
				<h5>м.Бориспіль<br>м.Київ(ст. м. "Лівобережна")</h5>
			</div>
...
<script>
    function initMap() {
        var markerArray = [];
        var start = {lat: 50.348573, lng: 30.955783};
        var finish = {lat: 50.452024, lng: 30.598496}
					...
					<div class="timetable">
						<table class="table">
							<tr>
								...
								<td class="table_header">м.Київ</td>
							</tr>
							<tr>
								<td>05:30</td>
								<td>06:30</td>
                        ...
                        <p>*Приблизний час відправлення. Інтервал руху автобусів 10-15 хв</p>
					</div>
				</div>
				<div class="col-md-5">
...
<!--				<h3>Місце посадки (м.Бориспіль)</h3>-->
...
<!--				</div>-->
<!--				<h3>Місце висадки (м.Київ(ст.м. "Лівобережна"))</h3>-->
